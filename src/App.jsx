...
import { API_BASE_URL } from './api/eventsApi.js';
...
export const PARTY_NAME = "Civic Progress Alliance";
export const SLOGAN = "Building a Better Tomorrow, Together.";
export const THEME = {
...
useEffect(() => {
  const fetchWorks = async () => {
    try {
      ...
      const res = await axios.get(`${API_BASE_URL}/work_tracking/auth/user/GetAllWorks?page=1&limit=3&verified=true`);
